...
from models.coresetVit import CoresetVit
...
@register_model
def coresetvit_tiny_patch16_224(pretrained=False, **kwargs):
...
@register_model
def coresetvit_small_patch16_224(pretrained=False, **kwargs):
...
@register_model
def coresetvit_base_patch16_224(pretrained=False, **kwargs):
    from models.topk import TopKVisionTransformer
